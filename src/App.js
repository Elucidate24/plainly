...
const T = {
  en: {
    ...
    landingHeadline: "Do you actually know what you just signed?",
    landingSubtitle: "Most people don't. Legal language is written to confuse you. Plainly reads every clause, flags every risk and tells you exactly what you are agreeing to before you sign.",
  ...
  nl: {
    ...
    landingHeadline: "Weet jij eigenlijk wat je net hebt getekend?",
    landingSubtitle: "De meeste mensen niet. Juridische taal is geschreven om je te verwarren. Plainly leest elke clausule, markeert elk risico en vertelt je precies wat je ondertekent.",
  ...
  es: {
    ...
    landingHeadline: "¿Sabes realmente lo que acabas de firmar?",
    landingSubtitle: "La mayoría no lo sabe. El lenguaje legal está escrito para confundirte. Plainly lee cada cláusula, marca cada riesgo y te dice exactamente lo que estás aceptando.",
